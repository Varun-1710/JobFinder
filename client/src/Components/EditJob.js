...
function EditJob() {
    ...
    const {JobsData,JobId,HandleEditJob} = useContext(DataContext);
    
    const jobIndex = JobsData.findIndex(job => job._id.toString() === JobId);
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            <input
                                type='text'
                                name='CompanyName'
                                placeholder={JobsData[index].CompanyName}
                        ...
                        <div>
                            <input
                                type='text'
                                name='CompanyLogoURL'
                                placeholder={JobsData[index].CompanyLogoURL}
                        ...
                        <div>
                            <input
                                type='text'
                                name='Position'
                                placeholder={JobsData[index].Position}
                        ...
                        <div>
                            <input
                                type='text'
                                name='Salary'
                                placeholder={JobsData[index].Salary}
                        ...
                        <div>
                            <input
                                type='text'
                                name='JobLocation'
                                placeholder={JobsData[index].JobLocation}
                        ...
                        <div>
                            <input
                                type='text'
                                name='Description'
                                placeholder={JobsData[index].Description}
                        ...
                        <div>
                            <input
                                type='text'
                                name='AboutCompany'
                                placeholder={JobsData[index].AboutCompany}
                        ...
                        <div>
                            <input
                                type='text'
                                name='Information'
                                placeholder={JobsData[index].Information}
